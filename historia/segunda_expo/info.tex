...
\begin{titlepage}
  \begin{center}
      ...
      \Huge
      \textbf{Gobierno del doctor José Gaspar Rodríguez de Francia}

      \vspace{0.5cm}
      \LARGE
      \vspace{1.5cm}

      \textbf{Jonathan Bray, Ever Ortega, Cp, Amira}
...
\end{titlepage}
  ...
  \hrule
  \vspace{0.5cm}
  \subsection*{Nota del 20 de julio de 181dotfill2\\

  Obras de la Junta Superior Gubernativa \dotfill2\\
  Educación \dotfill2\\
  Economía \dotfill2\\
  Misión de Nicolás Herrera \dotfill2\\
  Segundo Congreso Nacional, 1813 \dotfill2\\
