...
void reducimiento(int vector[], int cant){
    ...
    for (int i = 0; i < cant; i++)
    {
        ...
        printf("El prisionero %d esta con %d meses de condena, ahora, y podria librarse con %d libros\n", i+1, vector[i], libros[i]); //Ns pq me sale 3958793759378 en cantidad de libros en el primer reo
    }
...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        printf("Ingrese la cantidad de meses que tiene como condena el reo %d: ", i+1);
